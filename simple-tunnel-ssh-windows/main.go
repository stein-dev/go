...
import (
	...
	"github.com/stein/simple-tunnel-ssh-windows/libinject"
	"github.com/stein/simple-tunnel-ssh-windows/liblog"
	"github.com/stein/simple-tunnel-ssh-windows/libutils"
	"github.com/stein/simple-tunnel-ssh-windows/libopenvpn"
...
func main() {
	...
	liblog.LogInfo("Simple Tunnel SSH | @pigscanfly", "", Colors["B1"])
